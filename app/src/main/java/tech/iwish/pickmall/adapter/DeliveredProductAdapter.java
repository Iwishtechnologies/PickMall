...
import tech.iwish.pickmall.activity.DeliveredItemActivity;
...
public class DeliveredProductAdapter  extends  RecyclerView.Adapter<DeliveredProductAdapter.ViewHolder> {
    ...
    private DeliveredItemActivity context ;
    private List<OrderList> orderLists ;
    HashMap<String,String> product= new HashMap<>();

    public  DeliveredProductAdapter(DeliveredItemActivity  context,List<OrderList>orderLists) {
        this.context= context;
        this.orderLists=orderLists;
    }
    @NonNull
    @Override
    public DeliveredProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_delivered_order_design , null);
        DeliveredProductAdapter.ViewHolder viewHolder= new DeliveredProductAdapter.ViewHolder(view);
        return viewHolder;
    }
