...
import tech.iwish.pickmall.RetrofitModel.FlashSale_friendDeal.Friendsdatum;
...
public class FriendSaleAdapter extends RecyclerView.Adapter<FriendSaleAdapter.Viewholder> {
    ...
    private final List<Friendsdatum> friendSaleLists;
...
//    }
    ...
    public FriendSaleAdapter(MainActivity mainActivity, List<Friendsdatum> friendsdata) {
        this.context = mainActivity;
        this.friendSaleLists = friendsdata;
    }

    @NonNull
    @Override
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Viewholder(LayoutInflater.from(context).inflate(R.layout.row_friend_sale, null));
    }
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.one_rus.setText(context.getResources().getString(R.string.rs_symbol) + friendSaleLists.get(position).getActualPrice());
