...
public class MyOederActitvity extends AppCompatActivity implements InternetConnectivityListener {
                        ...
                        if (responses.equals("TRUE")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                orderLists.add(new OrderList(jsonHelper.GetResult("orderid"),jsonHelper.GetResult("customer_id"),jsonHelper.GetResult("delhivery_address"),jsonHelper.GetResult("order_amount"),jsonHelper.GetResult("payment_method"),jsonHelper.GetResult("gst"),jsonHelper.GetResult("shipping_charge"),jsonHelper.GetResult("status"),jsonHelper.GetResult("product_id"),jsonHelper.GetResult("qty"),jsonHelper.GetResult("type"),jsonHelper.GetResult("color"),jsonHelper.GetResult("size"),jsonHelper.GetResult("datetime"),
                                        jsonHelper.GetResult("item_id"),jsonHelper.GetResult("actual_price"),jsonHelper.GetResult("discount_price"),jsonHelper.GetResult("discount_price_per"),jsonHelper.GetResult("pimg"),jsonHelper.GetResult("FakeRating"),jsonHelper.GetResult("hot_product"),jsonHelper.GetResult("hsn_no"),jsonHelper.GetResult("weight"),jsonHelper.GetResult("flash_sale"),jsonHelper.GetResult("product_name"),jsonHelper.GetResult("order_status"),jsonHelper.GetResult("vendor_id"),jsonHelper.GetResult("delivery_date"),jsonHelper.GetResult("ordertype"),jsonHelper.GetResult("uniqueid")));
                            }
    ...
    public void Connectivity(){
        ...
        mInternetAvailabilityChecker.addInternetConnectivityListener(MyOederActitvity.this);
    }
    ...
    public void onInternetConnectivityChanged(boolean isConnected) {
        if (isConnected){
            ...
            startActivity(new Intent(MyOederActitvity.this,NoInternetConnectionActivity.class));
        }
    }
